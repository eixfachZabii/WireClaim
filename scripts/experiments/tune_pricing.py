"""Measure the pricing constants in `src.pricing` against the real payoff table.

Why this exists
---------------
`src/pricing.py` carries three fitted numbers -- the Charge factor line, the Limit
