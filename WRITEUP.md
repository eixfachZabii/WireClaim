...
- **We climbed from last to 5th.** After nine Games we were **17th of 17**. We are now **5th** on
  **+238,255** weighted. Over the **75 Games since the estimator was working** we are **2nd of 17
  by rate** (+4,865/Game), and re-basing every team to zero at Game 20 — when it went live — puts
  us **2nd of 17** at **+409,191**.
- **The distribution is tight, which is the part we would actually defend.** **4 losing Games in
  the last 20, the worst costing 15,883**; 4 losing Games in the last 30, third fewest of any team.
  That is the **2nd-best risk-adjusted return in the field** (mean/σ = 0.64 vs 0.86). Seven teams
  carry a single Game worse than −80,000; our deepest hole in thirty Games is −15,883 — the very
  last Game of the tournament. In an
