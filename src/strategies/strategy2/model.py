...
first (`src.evidence.policy.slice`), which halves the prompt and removes the blocking ~20 s LLM
...
from src.strategies.strategy2.constants import LLM_TIMEOUT_SECONDS
from src.strategies.strategy2.prompts import PROMPT
