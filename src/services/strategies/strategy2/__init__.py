...
chosen:
    ...
    from src.services.strategies.strategy2 import channels, model, blend, prompts

See `strategy.py` for the module map and the two failure modes the design is built around.
"""

from src.services.strategies.strategy2 import blend, channels, constants, model, prompts
